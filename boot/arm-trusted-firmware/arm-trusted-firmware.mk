...
define ARM_TRUSTED_FIRMWARE_BUILD_FIPTOOL
	...
	if [ "${BR2_NUVOTON_MA35D1}" == "y" ] && [ "${BR2_NUVOTON_MA35D1_D0}" == "y" ]; then \
	if [ "${TFA_CPU650_CUSTOM_DDR}" == "y" ]; then \
		cp $(BASE_DIR)/../board/nuvoton/ma35d0/ddr/$(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)) $(@D)/plat/nuvoton/$(call qstrip,ma35d1)/include/custom_ddr.h; \
	fi \
	fi
...
ifeq ($(BR2_TARGET_OTP_ANTI_ROLLBACK),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += OTP_ANTI_ROLLBACK=1
endif
...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=0 MA35D1_CPU_CORE=$(TFA_MA35D1_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1_PMIC_1),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=1 MA35D1_CPU_CORE=$(TFA_MA35D1_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1_PMIC_2),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=2 MA35D1_CPU_CORE=$(TFA_MA35D1_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1_PMIC_3),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=3 MA35D1_CPU_CORE=$(TFA_MA35D1_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1_VOL_CORE_POWER)
endif

ifeq ($(TFA_MA35D1D0_PMIC_0),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=0 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1D0_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_1),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=1 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1D0_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_2),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=2 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1D0_VOL_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_3),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=3 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER) MA35D1_VOL_CORE=$(TFA_MA35D1D0_VOL_CORE_POWER)
endif
endif
