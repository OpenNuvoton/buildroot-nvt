...
ARM_TRUSTED_FIRMWARE_PLATFORM = $(call qstrip,"ma35d1")
else
...
ifeq ($(TFA_CPU650_CUSTOM_DDR),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu650-custom-ddr"
endif
...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=0 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_1),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=1 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_2),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=2 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER)
else ifeq ($(TFA_MA35D1D0_PMIC_3),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += MA35D1_PMIC=3 MA35D1_CPU_CORE=$(TFA_MA35D1D0_CPU_CORE_POWER)
endif
endif
